...
function Home() {
  return (
    <div className="home-page home-guide-page">
      ...
      <section className="get-started-section-modern">
        <div className="container">
          <div className="get-started-card">
            ...
            <div className="get-started-content">
              <h2 className="get-started-title">¿Listo para comenzar?</h2>
              <p className="get-started-description">
                Dirígete a la sección de Análisis para cargar tu primera imagen médica y experimentar el poder de la IA médica
              </p>
              <div className="get-started-features">
                ...
                <div className="feature-item">
                  <span>Precisión avanzada</span>
                </div>
                <div className="feature-item">
                  <span>Reportes detallados</span>
                </div>
              </div>
              <Link to="/analisis" className="get-started-btn-modern">
