        ...
        return (
          <div className="symptoms-section">
            <div className="form-group">
              <label htmlFor="sintomas">Describa los síntomas o motivo de consulta</label>
              <textarea 
                className="form-control" 
                id="sintomas" 
                name="sintomas"
            ...
            <div className="symptoms-tips">
              ...
              <ul>
                <li>Mencione cuándo comenzaron los síntomas</li>
                <li>Describa la intensidad y frecuencia</li>
                <li>Indique si hay factores que empeoran o mejoran los síntomas</li>
                <li>Mencione tratamientos previos y su efectividad</li>
                <li>Incluya cualquier otra información que considere relevante</li>
              </ul>
            </div>
          </div>
        );
